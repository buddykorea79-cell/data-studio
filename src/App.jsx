...
const APPS = [
  ...
  },
  {
    ...
    label: "LibroSpace",
    category: "문서 · 지식",
    tagline: "도서·매뉴얼·가이드를 한 서재에",
    desc: "챕터를 나눠 오래 쓰는 책부터 AI가 만들어 준 HTML 한 장까지, 형태가 제각각인 문서를 같은 서재에 나란히 올려 관리하고 공개하는 플랫폼.",
    tags: ["전자책", "매뉴얼", "마크다운", "본문 검색"],
    color: "#6E56CF",
    href: "https://librospace-three.vercel.app/#/",
  },
  {
    id: "videostudio",
    status: "wip",
    ...
    label: "Video Studio",
    category: "미디어",
    tagline: "폴더 속 사진을 동영상으로",
    desc: "폴더에 있는 사진을 동영상으로 만들어 주는 웹앱. 화질을 먼저 고르게 맞춘 뒤 줌·팬·전환 효과를 얹어 mp4로 뽑아냅니다.",
    tags: ["사진 → 영상", "화질 보정", "줌·팬 효과", "mp4"],
    color: "#E5484D",
  },
];
